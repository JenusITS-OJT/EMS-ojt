...
<?php require('S_Sidebar.php');?>
  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <div class="alert alert-danger alert-dismissible">
                ...
                Employee's credentials can't be set. an employee already possessed the ID. To view employee's further details, click <a href= "T_ViewEmployeeList.php"><b>Here</b></a>
    </div>
