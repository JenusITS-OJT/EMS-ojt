    ...
    <div class="content-wrapper">
      ...
      <!-- SELECT2 EXAMPLE -->
        <div class="box box-warning">
          ...
          <form action="F_CM_Leave.php" method="get">
            ...
            <div class="box-body">              
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="leave" name="leave" placeholder="Leave Name" value="<?php echo $leavename; ?>" required>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="desc" name="desc" placeholder="Description" value="<?php echo $desc; ?>" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" id="type" name="type" placeholder="Leave Type" required>
            ...
            <div class="box-footer" align="right">
              ...
              &nbsp;&nbsp;&nbsp;
              <a href="CM_Leave.php"><button type="button" class="btn btn-default">Cancel</button></a>
            </div>
          </form>
        </div>
            ...
            <table id="leave" class="table table-bordered table-striped">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                        <form action="CM_Leave1.php?id=<?php echo $_GET['id'];?>" method="get">
                          ...
                          &nbsp;
                        <form action="CM_Leave2.php?id=<?php echo $_GET['id'];?>" method="get">
