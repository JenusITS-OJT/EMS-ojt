...
if (isset($_GET['id']))
  $id = $_GET['id'];   
   ...
   header("Location: CM_Department.php");
?>
<head>
  <meta charset="utf-8">
  ...
  <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      ...
      <div class="box box-warning">
        ...
        <form action="F_CM_Department.php" method="get">
        ...
        <div class="box-body">                
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="department" name="department" placeholder="Department Name" value="<?php echo $dept; ?>" required>
            </div>
  	      </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="description" name="description" placeholder="Department Function/s" value="<?php echo $desc; ?>" required>              
              <!-- <textarea class="form-control" id="description" name="description" placeholder="Department Function/s" value="<?php echo $desc; ?>" required></textarea> -->
            </div>
          </div>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <td>
                  <div class="btn-group">
                    ...
                    <form action="CM_Department1.php?id=<?php echo $_GET['id'];?>" method="get">
                    ...
                    &nbsp;
                    <form action="CM_Department2.php?id=<?php echo $_GET['id'];?>" method="get">
