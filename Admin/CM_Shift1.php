    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box box-warning">
          ...
          <form action="F_CM_Shift.php" method="get">
            <?php $sql="SELECT 
                          s.`id`, 
                          s.`Shift`,
                          DATE_FORMAT(s.`Time_From`, '%r'),
                          DATE_FORMAT(s.`Time_To`, '%r')
                          FROM `shift` as s";
            ...
            <div class="box-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Shift Name" value="<?php echo $shift; ?>" required/>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="time" class="form-control" id="timefrom" name="timefrom" placeholder="Time From" value="<?php echo $from; ?>" required/>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="time" class="form-control" id="timeto" name="timeto" placeholder="Time To" value="<?php echo $to; ?>" required/>
                </div>
              </div>
            </div>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <form action="CM_Shift1.php?id=<?php echo $_GET['id'];?>" method="get">
                          ...
                          &nbsp;
                        <form action="CM_Shift2.php?id=<?php echo $_GET['id'];?>" method="get">
