            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="contactno" name="contactno" placeholder="Contact Number" value="<?php echo $contact; ?>" required/>
                </div>
              </div>
                  ...
                  <td>
                    <div class="btn-group">
                        <form action="CM_Branch1.php?id=<?php echo $_GET['id'];?>" method="get">
                          ...
                          &nbsp;
                        <form action="Form_CM_Branch2.php?id=<?php echo $_GET['id'];?>" method="get">
