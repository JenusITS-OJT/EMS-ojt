    ...
    <div class="content-wrapper">
      ...
      <!-- SELECT2 EXAMPLE -->
          <div class="box box-warning">
            ...
            <form action="F_CM_Status.php" method="get">
              ...
              <div class="box-body">                  
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="statusname" name="statusname" placeholder="Status Name" value="<?php echo $statusname; ?>" required/>
                  </div>
                </div>
            ...
            <div class="box-body" style="overflow-x:auto;">
              <table id="status" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <td>
                    <div class="btn-group">
                      <form action="CM_Status1.php?id=<?php echo $_GET['id'];?>" method="get">
                          ...
                          &nbsp;
                        <form action="CM_Status2.php?id=<?php echo $_GET['id'];?>" method="get">
