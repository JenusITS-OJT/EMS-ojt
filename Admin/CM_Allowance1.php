...
if (isset($_GET['id']))
  $id = $_GET['id'];   
   ...
   header("Location: CM_Allowance.php");
?>
<head>
  <meta charset="utf-8">
      ...
      <!-- SELECT2 EXAMPLE -->
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Update Allowance</h3>
          ...
          <form action="F_CM_Allowance.php" method="get">
            ...
            <div class="box-body">              
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputEmail1">Allowance</label>
                  <input type="text" class="form-control" id="allowance" name="allowance" placeholder="Allowance" value="<?php echo $allowance; ?>" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="number" min="0" class="form-control" id="amount" name="amount" placeholder="Amount" value="<?php echo $amount; ?>" required>
                </div>
              </div>
            ...
            <div class="box-footer" align="right">
              ...
              &nbsp;&nbsp;&nbsp;
              <a href="CM_Allowance.php"><button type="button" class="btn btn-default">Cancel</button></a>
            </div>
          </form>
        </div>
