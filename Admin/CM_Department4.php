            ...
            <div class="box-body">                  
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="description" name="description" placeholder="Department Function/s" required>
                  <!-- <textarea class="form-control" id="description" name="description" placeholder="Department Function/s" required></textarea> -->
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
