            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="holiday" name="holiday" placeholder="Holiday Name" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" id="holitype" name="holitype" placeholder="Select Holiday Type" required>
