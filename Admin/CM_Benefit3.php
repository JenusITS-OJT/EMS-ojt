            ...
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="benefit" name="benefit" placeholder="Benefits" value="<?php echo $benefit; ?>" required/></textarea>
                </div>
              </div>
             ...
             <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="desc" name="desc" placeholder="Benefits Description" value="<?php echo $desc; ?>" required/></textarea>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="amount" name="amount" placeholder="Amount" value="<?php echo $amount; ?>" required/></textarea>
                </div>
              </div>
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <form action="CM_Benefit1.php?id=<?php echo $_GET['id'];?>" method="get">
                          ...
                          &nbsp;
                        <form action="CM_Benefit2.php?id=<?php echo $_GET['id'];?>" method="get">
