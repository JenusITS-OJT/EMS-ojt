    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        <div class="box box-warning">
          ...
          <form action="F_CM_Branch.php" method="get">
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputEmail1">Leave Type Name</label>
                  <textarea class="form-control" id="leave" name="leave" placeholder="Leave Name" required/></textarea>
                </div>
              </div>
            ...
            <div class="box-body">
              <div class="col-md-12">
                <div class="form-group">
                  <label for="exampleInputEmail1">Leave Type Description</label>
                  <textarea class="form-control" id="leavedesc" name="leavedesc" placeholder="Leave Description" required/></textarea>
                </div>
              </div>
