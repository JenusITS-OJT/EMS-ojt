...
if (isset($_GET['id']))
  $id = $_GET['id'];   
   ...
   header("Location: CM_Holiday.php");
?>
<head>
  <meta charset="utf-8">
    ...
    <div class="content-wrapper">
      ...
      <!-- SELECT2 EXAMPLE -->
        <div class="box box-warning">
          ...
          <form action="F_CM_Holiday.php" method="get">
            ...
            <div class="box-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Holiday</label>
                  <input type="text" class="form-control" id="holiday" name="holiday" placeholder="Holiday Name" value="<?php echo $name; ?>" required>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    ...
                    <input type="date" class="form-control pull-right" id="datepicker" name="datepicker" value="<?php echo $date; ?>" required></input>
                  </div>
                  <!-- /.input group -->
                </div>
              </div>                        
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="exampleInputEmail1">Holiday Type</label>
                  <select class="form-control" id="holitype" name="holitype" placeholder="Select Holiday Type" value="<?php echo $type; ?>"required>
              ...
              <div class="box-footer" align="right">
                ...
                &nbsp;&nbsp;&nbsp;
                <a href="CM_Holiday.php"><button type="button" class="btn btn-default">Cancel</button></a>
              </div>
            </div>
          ...
          <div class="box-body" style="overflow-x:auto;">
            <table id="branch" class="table table-bordered table-striped">
              ...
              <?php $sql="SELECT 
                ...
                h.`Name`, 
                h.`Holiday_Type`, 
                DATE_FORMAT(h.`Holiday_Date`,'%M %d, %Y'),
                h.`Status`
                  FROM `holidays` AS h
                  where h.`status` = '1'";
                    $result = mysqli_query($con, $sql);
