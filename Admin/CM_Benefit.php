            ...
            <div class="box-body">
              <div class="col-md-12">
               ...
               <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="desc" name="desc" placeholder="Description" required/></textarea>
                </div>
              </div>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="amount" name="amount" placeholder="PHP 0000.00" required/></textarea>
                </div>
              </div>
