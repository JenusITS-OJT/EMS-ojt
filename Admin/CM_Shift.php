  ...
  <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="S_Sidebar Dashboard.php"><i class="fa fa-dashboard"></i> Home</a></li>
            ...
            <div class="box-body">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" name="name" placeholder="Shift Name" required/>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="time" class="form-control" id="timefrom" name="timefrom" placeholder="Time From" required/>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <input type="time" class="form-control" id="timeto" name="timeto" placeholder="Time To" required/>
                </div>
              </div>
            </div>
