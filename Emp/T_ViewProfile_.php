              ...
              <div class="row">
                <div class="col-sm-12 border-right">
                  <div class="description-block">
                    ...
                    <form action="Upload_.php?userid=<?php echo $_POST['userid'];?>&name=<?php echo $_POST['name'];?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <form action="T_UpdateProfile_.php?userid=<?php echo $_GET['userid'];?>" method="get">
        ...
        <div class="col-md-8">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <form action="T_Education_.php?userid=<?php echo $_GET['userid'];?>" method="get">
                    <button type="submit" class="btn form-control btn-warning"  value="Update">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <form action="T_Family_.php?userid=<?php echo $_GET['userid'];?>" method="get">
                    <button type="submit" class="btn form-control btn-warning"  value="Update">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <form action="T_Work_.php?userid=<?php echo $_GET['userid'];?>" method="get">
                    <button type="submit" class="btn form-control btn-warning"  value="Update">
            ...
            <div class="box box-warning">
              <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                  <form action="T_Contact_.php?userid=<?php echo $_GET['userid'];?>" method="get">
                    <button type="submit" class="btn form-control btn-warning"  value="Update">
